...
int main(void) {
    ...
    printf("\n\r----------------------------------------------------------------------------------------------------------------");
    printf("\n\r- This example illustrates how to use the STSAFE-L010 Secure Element and STMicroelectronics Secure Element      ");
    printf("\n\r- Library to perform device/accessory authentication using Multi-Step approach.                                -");
    printf("\n\r- It can be taken as reference for building distant server authentication use cases.                           -");
    printf("\n\r-                                                                                                              -");
    printf("\n\r- accesses/commands to the target STSAFE device or STSELib                                                     -");
    printf("\n\r-          o Certificate API (stse_certificate_parse, stse_certificate_is_parent)                              -");
    printf("\n\r-          o Certificate prints API (stse_certificate_print_parsed_cert)                                       -");
    printf("\n\r-          o Device authentication API (stse_get_device_certificate_size, stse_get_device_certificate)         -");
    printf("\n\r-          o Certificate crypto API (stse_certificate_get_key_type, stse_certificate_verify_signature)         -");
    printf("\n\r-          o ECC API (stse_ecc_generate_signature)                                                             -");
    printf("\n\r-                                                                                                              -");
    printf("\n\r----------------------------------------------------------------------------------------------------------------");
